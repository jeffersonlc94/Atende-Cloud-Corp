  ...
  const duplicated = await prisma.$transaction(async (tx) => {
    ...
    return tx.quote.create({
      data: {
        ...
        descontoProdutosTipo: original.descontoProdutosTipo,
        descontoProdutosValor: original.descontoProdutosValor,
        descontoServicosTipo: original.descontoServicosTipo,
