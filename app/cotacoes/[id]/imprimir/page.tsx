...
export default function PrintSupplierQuotationPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="min-h-screen bg-slate-200 p-4 print:bg-white print:p-0">
    ...
    <style jsx global>{`
      ...
      .print-green-header { background-color: #00845d !important; color: #ffffff !important; }
      @media print {
        html, body, body * {
        ...
        .print-green-header,
        .print-green-header th {
          background: #00845d !important;
          background-color: #00845d !important;
