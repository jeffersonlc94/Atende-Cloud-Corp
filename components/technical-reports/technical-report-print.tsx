...
export function TechnicalReportPrint({ report, id = "technical-report-print" }: { report: TechnicalReportPrintData; id?: string }) {
  ...
  return <div id={id} className="mx-auto min-h-[297mm] w-full max-w-[210mm] bg-white p-7 text-black print:p-5" style={{ fontFamily: "Arial, Helvetica, sans-serif", fontSize: "16px" }}>
    ...
    <Section title="Problema relatado" minHeight="24mm">{report.problemaRelatado}</Section>
    <Section title="Problemas encontrados" minHeight="34mm">{report.problemasEncontrados}</Section>
    <Section title="Procedimentos realizados" minHeight="38mm">{report.procedimentosRealizados}</Section>
    <Section title="Conclusão do laudo" minHeight="25mm">{report.conclusao}</Section>
